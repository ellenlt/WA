class UsersController < ApplicationController
    ...
    # Filters photos according to the filter method in the Photo model
    # and passes the results to a partial page template
    def filter_photos
      @matching_photos = Photo.filter(params[:substring])
      render :partial => "photo_filter"
    end
